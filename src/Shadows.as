...
//}
    ...
    /**
     * It shows a two-dimensional plane 
     * @author codeonwort
     */
...
//{
    ...
    internal class Study_ShadowOnPlane extends Study_Base 
    {
        ...
        // It makes a shadow projection matrix for a particular plane .
        // n: Unit normal vector of the plane
        // r: Any point including a flat
        // L: Unit direction vector of light
...
/* Models in top - perspective transformation applied
va0: vertex position
va1: vertex color
...
/* Vertex shader for shadow projection (Model -> Shadow -> perspective transformation )
va0: vertex position
va1: vertex color
vc0~3: model transform matrix
vc4~7: perspective transform matrix
